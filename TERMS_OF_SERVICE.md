...
- You are responsible for your store's security
...
- Trials can be used once per plan
- No payment required during trial
- After trial, subscription required to continue

### 4.3 Billing
- Charges are processed through Shopify's billing system
...
- Recurring monthly charges to your Shopify account
- Automatic renewal until cancellation
- Price changes with 30 days notice

### 4.5 Refund Policy
- **Trial Period**: Cancel anytime during trial with no charge
- **Paid Subscriptions**: No refunds for partial months
- **Downgrade**: Takes effect at next billing cycle
- **Upgrade**: Charged immediately, prorated

### 4.6 Usage Limits
- Product creation limits reset monthly on billing date
- Exceeding limits requires plan upgrade
- Unused products do not roll over
...
- Import products you have rights to sell
...
- Import counterfeit or unauthorized products
- Violate third-party copyrights or trademarks
- Attempt to bypass usage limits
- Share your account credentials
- Reverse engineer the App
- Use the App to spam or harass
- Scrape or abuse external websites

### 5.3 Content Responsibility
You are solely responsible for:
- Products you import and sell
- Accuracy of product information
- Legal compliance of your products
...
### 6.1 App Ownership
- We own all rights to the App and its features
- You receive a limited, non-exclusive license to use the App
- License terminates upon account closure or violation

### 6.2 Your Content
- You retain ownership of your product data
- You grant us a license to process and store your data to provide services
- You are responsible for having rights to import content

### 6.3 AI-Generated Content
- AI-generated descriptions are provided as suggestions
- You are responsible for reviewing and approving all content
- We do not guarantee accuracy or originality of AI content
- You assume liability for published AI content

## 7. Third-Party Services

### 7.1 External Platforms
- Product import relies on scraping external websites
- We are not responsible for changes to external platforms
- Availability may vary by platform
- You must comply with terms of external platforms

### 7.2 AI Services
- We use OpenAI and Google AI for content generation
- AI services have their own terms and policies
- AI availability may be limited or interrupted
- Quality of AI output may vary

### 7.3 Shopify Platform
- The App operates on Shopify's infrastructure
- Shopify's terms and policies apply
- We are not responsible for Shopify service issues
...
### 9.1 Data Collection
- See our Privacy Policy for details on data collection
- We collect only necessary data to provide services
- You control data shared with third parties
...
### 9.3 Data Deletion
- Uninstalling the App triggers data deletion
...
- Total liability limited to fees paid in the last 3 months
- We are not liable for third-party actions or content
- You assume all risk of using the App
...
### 16.1 Shopify Requirements
This App complies with Shopify's App Store requirements and guidelines.

### 16.2 Review Guidelines
We adhere to Shopify's app review guidelines and policies.

## Acknowledgment

By using Product Import Pro, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.
